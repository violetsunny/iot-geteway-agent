package top.iot.gateway.network.tcp.server;
...
import top.iot.gateway.network.tcp.client.VertxTcpClient;
...
public class VertxTcpServer implements TcpServer {
    ...
    protected void acceptTcpConnection(NetSocket socket) {
        ...
        try {
            ...
            // set方法 top.iot.gateway.community.network.tcp.server.VertxTcpServer.setParserSupplier
            // 调用坐标 top.iot.gateway.community.network.tcp.server.TcpServerProvider.initTcpServer
