package top.iot.gateway.network.mqtt.server.vertx;

import top.iot.gateway.network.mqtt.server.MqttConnection;
import top.iot.gateway.network.mqtt.server.MqttPublishing;
import top.iot.gateway.network.mqtt.server.MqttSubscription;
import top.iot.gateway.network.mqtt.server.MqttUnSubscription;
...
import top.iot.gateway.core.server.mqtt.MqttAuth;
...
class VertxMqttConnection implements MqttConnection {
    ...
    public MqttConnection accept() {
        ...
        log.info("mqtt client [{}] connected", getClientId());
        accepted = true;
        try {
