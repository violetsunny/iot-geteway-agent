...
public class DeviceMessageConnector implements DecodedClientMessageHandler {
            ...
            if (message instanceof DeviceMessage) {
                ...
                return deviceRegistry
                        ...
                        .flatMapIterable(configs -> {
                            ...
                            String productId = String.valueOf(deviceMessage.getHeader(PropertyConstants.productId.getKey()).orElse(null));
    ...
    public Mono<Void> onMessage(Message message) {
        ...
        message.addHeader(PropertyConstants.uid.getKey(), IDGenerator.SNOW_FLAKE_STRING.generate());
        return this
                .getTopic(message)
